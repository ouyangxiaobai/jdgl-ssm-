...
<html lang="en">
 ...
 <body>
       ...
       <header style="width: 100%">
	          <div>
							<a href="index.html" style="font-style:inherit; ; ;font-size: 40px">北京唐拉雅秀酒店</a> <span>会员登录</span>
			  </div>

	   </header>
       <section style="width: 100%">
	        <div class="left" style="width: 70%">
			    <img src="../resources/home/images\index.jpg" alt="" style="width: 100%">
			</div>
			<div class="login" style="height: 629px">
			     ...
			     <div class="reg"> <a href="reg">立即注册 &gt;&gt;</a></div>
			</div>
